...
import com.hh.register.service.SendSms;
...
public class SendSmsImpl implements SendSms {
    ...
    public boolean send(String phoneNum, String templateCode, String code){
        try {
            ...
            Credential cred = new Credential("AKIDtncKxX1Q7h8QaaRBmEYjldLuKfrun9NT",
                    "1ueEfy9C6rSuCMMFzbYN4c1HOMCsQo39");
            ...
            String sdkAppId = "1400839582";
            req.setSmsSdkAppId(sdkAppId);

            /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名 */
            // 签名信息可前往 [国内短信](https://console.cloud.tencent.com/smsv2/csms-sign) 或 [国际/港澳台短信](https://console.cloud.tencent.com/smsv2/isms-sign) 的签名管理查看
            String signName = "HH小站公众号";
