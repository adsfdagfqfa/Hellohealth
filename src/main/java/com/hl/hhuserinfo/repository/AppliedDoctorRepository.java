...
import com.hl.hhuserinfo.entity.dto.DetailCerti;
import com.hl.hhuserinfo.entity.po.AppliedDoctor;
...
public interface AppliedDoctorRepository extends JpaRepository<AppliedDoctor,Integer> {
    ...
    // 获得最新的且通过审核的apply
    @Modifying
    @Query(value = "SELECT NEW com.hl.hhuserinfo.entity.dto.DetailCerti(b.reviewTime,a.title,a.department,a.hospitalRank) " +
